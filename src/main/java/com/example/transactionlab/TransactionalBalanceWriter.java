...
public class TransactionalBalanceWriter {
    ...
    private static final Logger log = LoggerFactory.getLogger(TransactionalBalanceWriter.class);

    private final AccountBalanceRepository repository;

    public TransactionalBalanceWriter(AccountBalanceRepository repository) {
